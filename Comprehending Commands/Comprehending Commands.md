...
/opt/linux/linux-5.4/scripts/kconfig/tests/preprocess/flag
...
hacker@commands~finding-files:~$ ls /opt/radare2/libr/flag
Makefile  flag.c  flag.o        meson.build  tags.d  zones.c  zones.o
d         flag.d  libr_flag.so  tags.c       tags.o  zones.d
hacker@commands~finding-files:~$ ls /nix/store/1yagn5s8sf7kcs2hkccgf8d0wxlrv5sz-radare2-5.9.0/share/radare2/5.9.0/flag
tags.r2
hacker@commands~finding-files:~$ ls /nix/store/pmvk2bk4p550w182rjfm529kfqddnvh3-python3.11-pwntools-4.12.0/lib/python3.11/site-packages/pwnlib/flag
...
__init__.py  __pycache__  flag.py
hacker@commands~finding-files:~$ ls /opt/linux/linux-5.4/scripts/kconfig/tests/preprocess/flag
/opt/linux/linux-5.4/scripts/kconfig/tests/preprocess/flag
